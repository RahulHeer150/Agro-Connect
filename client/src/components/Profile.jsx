    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-black to-gray-900 text-white p-6">
      <div className="max-w-5xl mx-auto mt-10 bg-white/10 backdrop-blur-lg rounded-2xl shadow-xl p-6">
        ...
        <div className="mt-6">
          ...
          {user.role === "farmer" && (
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p>
                  <strong>Farm:</strong> {user.farmDetails?.farmName || "N/A"}
                </p>
          ...
          {user.role === "buyer" && (
            <div>
              <h3 className="text-xl text-blue-400 mb-3">Business Details</h3>
              ...
              <p className="mt-2">
                <strong>Address:</strong> {user.buyerDetails?.address || "N/A"}
              </p>
